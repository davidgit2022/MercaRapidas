    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-custom">
                ...
                <h5 class="modal-title"><i class="voyager-plus icon-aling"></i>&nbsp; New food restriction </h5>
            </div>
            <div class="modal-body">
                <div class="form">
                    ...
                    <div class="form-group">
                        <label class="font-weight-bold is-required">Details:</label>
                        <textarea rows="5" class="form-control" wire:model='details'></textarea>
                        @error('details')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
